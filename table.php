...
<body>
    ...
    if (isset($_POST['submit'])) {
        ...
        $query = mysqli_query($conn, "INSERT INTO siswa(id_ujian, mata_pelajaran, guru, jumlah_soal, waktu)
        VALUES ('','$mata_pelajaran','$guru','$jumlah_soal','$waktu')");
        $get_id = mysqli_fetch_array(mysqli_query($conn, "SELECT * FROM siswa ORDER BY id_ujian"));
        $id = $get_id['id_ujian'];
    }
    ?>
    <div class="container">
            ...
            <div class="table-wrapper">
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        include "conn.php";
                        $no = 1;
                        $query = mysqli_query($conn, "SELECT * FROM siswa ORDER BY id_ujian DESC");
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <center><b><?= $data['mata_pelajaran'] ?></b></center>
                                </td>
                                <td>
                                    <center><?= $data['guru'] ?></center>
                                </td>
                                <td>
                                    <center><?= $data['jumlah_soal'] ?></center>
                                </td>
                                <td>
                                ...
                                <td>
                                    <center>
                                        ...
                                        <a href="edit_data.php?id=<?= $data['id_ujian'] ?>"><i class="bx bxs-pencil"></i> Edit</a> |
                                        <a href="hapus_data.php?id=<?= $data['id_ujian'] ?>" style="color:red" onClick="return confirm('Delete This Data ?')"><i class="bx bxs-trash"></i> Hapus</a>
                                    </center>
                                </td>
                            </tr>
                        <?php
                ...
                <div class="modal-body">
                    <form id="addEmployeeForm" action="" method="POST">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="guru" class="form-control" id="guru">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="jumlah_soal" class="col-sm-3 col-form-label">Jumlah Soal</label>
                            <div class="col-sm-9">
                                <input type="text" name="jumlah_soal" class="form-control" id="jumlah_soal">
                            </div>
                        </div>
                        <div class="row mb-3">
